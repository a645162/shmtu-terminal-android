...
class IdentityRepositoryImpl @Inject constructor(
    ...
    override suspend fun addIdentity(name: String): Long {
        return identityDao.insert(IdentityEntity(name = name))
    }
...
private fun IdentityEntity.toDomain() = EntityMappers.run { this@toDomain.toDomain() }
